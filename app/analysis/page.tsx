...
export default function Analysis() {
  useEffect(() => {
    const loadPage = document?.getElementById("analysis_page");
    if (loadPage) {
  ...
  return (
    <div
      id="analysis_page"
      className="min-h-[90vh] flex flex-col items-center justify-center bg-white text-center transition-all duration-800 ease-in-out"
      style={{ opacity: "0" }}
    >
      ...
      <div className="absolute bottom-38.5 md:bottom-8 w-full flex justify-between md:px-9 px-13 max-sm:bottom-8">
        <Link href="/result" className="group flex items-center gap-6 ">
          ...
          <span className="text-sm font-semibold sm:block max-[480px]:[display:none]">
            BACK
          </span>
        </Link>
