...
export default function Results() {
  ...
  const [inputPic, setInputPic] = useState<HTMLElement | null>(null);
  ...
  return (
    <div className="min-h-[92vh] flex flex-col bg-white relative md:pt-[64px] justify-center">
      ...
      >
        ...
        ></div>
        <div className="flex relative flex-col items-center bg-[#414141] opacity-85 rounded p-6 z-1010 text-white ">
          <button
            onClick={() => {
              if (overlay) {
                overlay.style.display = "none";
            ...
            className="flex absolute border rounded-full top-1 right-1 w-5 h-5 text-center items-center justify-center cursor-pointer transition-all  hover:bg-gray-500 "
          >
            X
          </button>
          <p className="mb-5 font-bold tracking-wider">
          ...
          <div className=" flex gap-4">
            {accessTo === "GALLERY" ? (
              <>
                <label
                  ...
                  className="border p-2 rounded-2xl hover:bg-gray-500 cursor-pointer transition-all"
                >
                  ALLOW
                </label>
              </>
            ...
            <button
              ...
              className=" hover:bg-gray-500 cursor-pointer p-2 rounded-2xl transition-all"
            >
              DENY
            </button>
          </div>
      ...
      <div className="flex-[0.4] md:flex-1 flex flex-col md:flex-row items-center xl:justify-center relative mb-0 md:mb-30 space-y-[-20px] md:space-y-0 justify-center">
        <div
          id="cameraButton"
        ...
        <div
          id="preview"
          className="absolute w-full h-full transition-all ease-in-out duration-500 flex flex-col items-center mt-12 md:mt-0 justify-center transition-opacity duration-300 opacity-100 bg-white"
        ...
        >
          ...
          <img
            src={LargeRectangle.src}
            alt=""
            className="absolute w-[480px] h-[480px] md:w-[762px] md:h-[762px] animate-spin [animation-duration:50s] rotate-200"
          />
          <img
            src={MediumRectangle.src}
            alt=""
            className="absolute w-[400px] h-[400px] md:w-[682px] md:h-[682px] animate-spin [animation-duration:70s] rotate-200"
          />
          <img
            src={SmallRectangle.src}
            alt=""
            className="absolute w-[320px] h-[320px] md:w-[602px] md:h-[602px] animate-spin [animation-duration:85s] rotate-200"
          />
          <div className="absolute inset-0 flex flex-col items-center justify-center -top-10 ">
            <div className="w-[100px] h-[100px] md:w-[200px] md:h-[200px]  mb-3 ">
              <img
            ...
            <div className="text-sm text-gray-400 tracking-wider mb-1">
